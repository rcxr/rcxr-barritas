(function(barritas, $, undefined) {
    ...
    switch(type) {
      case barritas.articleType.SHIRT:
        return $(`
          ...
          <path d="M28,55c-4.6,0-9.2-0.3-15.5-3.9c-0.6-0.4-1-1.1-1-1.8L12.4,25c-0.1,0-0.2,0-0.2,0c-0.1,0-0.2,0-0.3,0
          ...
          <path fill="` + color + `" d="M52.8,15.6c0,0-4.8-9.4-6-10.1C45.5,4.8,38.6,4.9,36,3.9c0,0-3.2,3.7-8,3.7c-4.8,0-8-3.7-8-3.7
          	c-2.6,1-9.6,0.9-10.8,1.6c-1.2,0.7-6,10.1-6,10.1c2.6,6.1,8.9,7.3,8.9,7.3l2.5-3.9l-1.2,30.3c6,3.5,10.3,3.7,14.5,3.7
          	c4.2,0,8.5-0.2,14.5-3.7l-1.2-30.3l2.5,3.9C43.8,23,50.2,21.7,52.8,15.6z"/>
          </svg>
        `);
  ...
  barritas.label = function(id, article) {
    var root = $("<div></div>").addClass("label-card")
      ...
      .append($("<div></div>").addClass("text-center").append($("<svg id=\"" + "barcode-".concat(id) + "\"></svg>")));
