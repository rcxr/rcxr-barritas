(function(barritas, $, undefined) {
    ...
    switch(type) {
      case barritas.articleType.SHIRT:
        return $(`
          ...
          <path fill="` + color + `" d="M28,55c-4.6,0-9.2-0.3-15.5-3.9c-0.6-0.4-1-1.1-1-1.8L12.4,25c-0.1,0-0.2,0-0.2,0c-0.1,0-0.2,0-0.3,0
  ...
  var getLoadingFilename = function() {
  ...
  barritas.label = function(article) {
    var root = $("<div></div>").addClass("label-card")
      ...
      .append($("<img id=\"" + "img-".concat(article.id) + "\"></img>").addClass("label-artwork").attr("src", getLoadingFilename()))
