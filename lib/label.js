// TODO: remove "new-" prefix in classes.
(function(barritas, $, undefined) {
  ...
  barritas.label = function(article) {
    ...
    var about = $("<div></div>").addClass("new-label-about-container d-flex")
      .append($("<div></div>").addClass("new-label-title").text(article.title))
      .append($("<div id=\"" + "qr-".concat(article.id) + "\"></qr>"));
    // Barcode.
    var barcode = $("<div></div>").addClass("new-label-barcode-container text-center")
